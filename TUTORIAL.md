...
Crear un directorio para contener el proyecto llamado `videojuego-educativo`.

Inicializar el reposito de Git
...
```sh
docker exec -it videojuego-educativo-web-service-1 sh
```

> **NOTA**  
> El nombre del contenedor (`videojuego-educativo-web-service-1`) puede cambiar dependiendo
